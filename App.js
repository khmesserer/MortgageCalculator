...
export default function App() {
  ...
  function Results({ keyId }) {
    ...
    return (
      <View key={keyId}> 
        {results.map(({ id, loanAmount, result, calcDate }) => (
          <Result key={id} id={id} loanAmount={loanAmount} result={result} calcDate={calcDate} />
        ))}
      </View>
    )
  }

  function Result({id, loanAmount, result, calcDate}){
    return (
      <View style={styles.historyRow} key={id}>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.historyContainer}>
          ...
          <ScrollView>
            <Results key={forceUpdateId} keyId={forceUpdateId}/>
          </ScrollView>
        </View>
      </View>
    );
